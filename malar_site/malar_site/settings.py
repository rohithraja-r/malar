"""
Django settings for malar_site project.
...
SECRET_KEY = 'django-insecure-jkp8a*cdd2@9l*^($ck)x46e8i!b(6y6=m=+o@s#11+0zbf=er'
...
WSGI_APPLICATION = 'malar_site.wsgi.application'
